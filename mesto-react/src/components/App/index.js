    ...
    <div className="body">
        <div className="page">
            <header className="header">
                <img className="header__logo" src="./image/Vector.svg" alt="Логотип"/>
            </header>
            ...
            <main>
                ...
                <div className="profile__info">
                    ...
                    <img className="profile__pencil" src="./image/Edit.svg" alt="Элемент редактирования" />
                    </button>
                    <p className="profile__subtitle">Идет загрузка...</p>
                </div>
                <button className="profile__add-button" type="button">
                    <img className="profile__plus" src="./image/Add_button.svg" alt="Знак - добавить" />
                </button>
        ...
        <div className="popup popup_type_edit">
            <div className="edit-form">
                <button className="popup__close edit-form__close-icon" type="button">
                    <img className="popup__close-image" src="./image/Close_Icon.svg" alt="Иконка - закрыть" />
                </button>
        ...
        <div class="popup popup_type_add">
            <div class="adding-cards">
                <button class="popup__close adding-cards__close-icon" type="button">
                    <img class="popup__close-image" src="<%=require('./image/Close_Icon.svg')%>" alt="Иконка - закрыть" />
                </button>
        ...
        <div class="popup popup_type_image">
            <div class="image-in-full">
                <button class="popup__close image-in-full__close-icon" type="button">
                    <img class="popup__close-image" src="./image/Close_Icon.svg" alt="Иконка - закрыть" />
                </button>
        ...
        <template id="card-template">
            <article class="element">
                <button class="element__button-delete" type="button">
                    <img class="element__delete" src="./image/delete_2.svg" alt="Иконка удаления карточки" />
                </button>
                ...
                <div class="element__down">
                    ...
                    <div class="element__likes">
                        <button class="element__button" type="button">
                            <img class="element__like" src="./image/Like.svg" alt="Лайк" />
                        </button>
